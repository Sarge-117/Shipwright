...
static std::map<std::string, CosmeticOption> cosmeticOptions = {
    ...
    COSMETIC_OPTION("NPC_ElecKeesePrimary",          "Elec Keese Primary",   GROUP_NPC,          ImVec4(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("NPC_ElecKeeseSecondary",        "Elec Keese Secondary", GROUP_NPC,          ImVec4(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("NPC_VoidKeesePrimary",          "Void Keese Primary",   GROUP_NPC,          ImVec4(255, 255, 255, 255), false, true, false),

...
#undef MESSAGE_COSMETIC_OPTION
    ...
    */
    ...
    COSMETIC_OPTION("NPC_IceKeeseSecondary",        "Ice Keese Secondary",      COSMETICS_GROUP_NPC,          ColorRGBA8(  0,   0, 255,   0), false, true, true),
    COSMETIC_OPTION("NPC_ElecKeesePrimary",         "Elec Keese Primary",       COSMETICS_GROUP_NPC,          ColorRGBA8(242, 250, 110, 255), false, true, false),
    COSMETIC_OPTION("NPC_ElecKeeseSecondary",       "Elec Keese Secondary",     COSMETICS_GROUP_NPC,          ColorRGBA8( 75,  80, 200,   0), false, true, true),
    COSMETIC_OPTION("NPC_VoidKeesePrimary",         "Void Keese Primary",       COSMETICS_GROUP_NPC,          ColorRGBA8( 23,  10,  46, 255), false, true, false),
    COSMETIC_OPTION("NPC_VoidKeeseSecondary",       "Void Keese Secondary",     COSMETICS_GROUP_NPC,          ColorRGBA8( 67,  31, 185,   0), false, true, true),
    COSMETIC_OPTION("NPC_WindKeesePrimary",         "Wind Keese Primary",       COSMETICS_GROUP_NPC,          ColorRGBA8( 10, 160,  40, 255), false, true, false),

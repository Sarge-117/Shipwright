...
static std::map<std::string, CosmeticOption> cosmeticOptions = {
    ...
    COSMETIC_OPTION("NPC_FireKeesePrimary",          "Fire Keese Primary",   GROUP_NPC,          ImVec4(255, 255, 100, 255), false, true, false),
    COSMETIC_OPTION("NPC_FireKeeseSecondary",        "Fire Keese Secondary", GROUP_NPC,          ImVec4(255,  50,   0,   0), false, true, true),
    COSMETIC_OPTION("NPC_IceKeesePrimary",           "Ice Keese Primary",    GROUP_NPC,          ImVec4(100, 200, 255, 255), false, true, false),
    COSMETIC_OPTION("NPC_IceKeeseSecondary",         "Ice Keese Secondary",  GROUP_NPC,          ImVec4(  0,   0, 255,   0), false, true, true),
    COSMETIC_OPTION("NPC_ElecKeesePrimary",          "Elec Keese Primary",   GROUP_NPC,          ImVec4(242, 250, 110, 255), false, true, false),

...
typedef enum {
    ...
    // Keese-Sanity special Keese types
    COUNT_ENEMIES_DEFEATED_KEESE_ELEC,           // EN_FIREFLY
    COUNT_ENEMIES_DEFEATED_KEESE_VOID,           // EN_FIREFLY
    COUNT_ENEMIES_DEFEATED_KEESE_WIND,           // EN_FIREFLY
    COUNT_ENEMIES_DEFEATED_KEESE_BLOOD,          // EN_FIREFLY
    COUNT_ENEMIES_DEFEATED_KEESE_LOVE,           // EN_FIREFLY

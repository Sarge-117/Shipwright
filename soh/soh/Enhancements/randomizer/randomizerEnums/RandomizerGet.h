...
RANDO_ENUM_ITEM(RG_DEKU_TREE_SMALL_KEY)
RANDO_ENUM_ITEM(RG_DODONGOS_CAVERN_SMALL_KEY)
RANDO_ENUM_ITEM(RG_JABU_JABU_SMALL_KEY)
RANDO_ENUM_ITEM(RG_ICE_CAVERN_SMALL_KEY)
RANDO_ENUM_ITEM(RG_TOMB_SMALL_KEY)
RANDO_ENUM_ITEM(RG_DEKU_TREE_BOSS_KEY)
RANDO_ENUM_ITEM(RG_DODONGOS_CAVERN_BOSS_KEY)
RANDO_ENUM_ITEM(RG_JABU_JABUS_BELLY_BOSS_KEY)

RANDO_ENUM_ITEM(RG_CUSTOM_FLAME_BLUE)
RANDO_ENUM_ITEM(RG_CUSTOM_FLAME_ORANGE)
RANDO_ENUM_ITEM(RG_CUSTOM_FLAME_GREEN)
RANDO_ENUM_ITEM(RG_CUSTOM_FLAME_PURPLE)

...
RANDO_ENUM_ITEM(LOGIC_BOSS_KEY_DEKU_TREE)
RANDO_ENUM_ITEM(LOGIC_BOSS_KEY_DODONGOS_CAVERN)
RANDO_ENUM_ITEM(LOGIC_BOSS_KEY_JABU_JABU)
...
RANDO_ENUM_ITEM(LOGIC_DEKU_TREE_KEYS)
RANDO_ENUM_ITEM(LOGIC_DODONGOS_CAVERN_KEYS)
RANDO_ENUM_ITEM(LOGIC_JABU_JABU_KEYS)
RANDO_ENUM_ITEM(LOGIC_ICE_CAVERN_KEYS)
RANDO_ENUM_ITEM(LOGIC_TOMB_KEYS)
...
RANDO_ENUM_ITEM(LOGIC_CUSTOM_FLAMES)
